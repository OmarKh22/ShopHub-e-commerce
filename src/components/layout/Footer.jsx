        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=beauty" className="text-gray-300 hover:text-white transition-colors">Beauty & Personal Care</Link>
              </li>
              <li>
                <Link to="/products?category=sports" className="text-gray-300 hover:text-white transition-colors">Sports & Outdoors</Link>
              </li>
            </ul>
          </div>
